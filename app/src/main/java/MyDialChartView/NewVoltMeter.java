...
public class NewVoltMeter extends MyMeter {
    ...
    private String mHeaderText = "X10mV"; // 表头
    ...
    public NewVoltMeter(Context context) {
        this(context, null);
    }

    public NewVoltMeter(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NewVoltMeter(Context context, AttributeSet attrs, int defStyleAttr) {
