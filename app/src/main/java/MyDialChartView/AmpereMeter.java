...
public class AmpereMeter extends MyGraphicalView {
    ...
    public AmpereMeter(Context context, float totalAngle) {
        super(context);
        chart = new MyChart(totalAngle);
        chartRender();
    }

    public AmpereMeter(Context context, AttributeSet attrs){
        super(context, attrs);
        chartRender();
    }

    public AmpereMeter(Context context, AttributeSet attrs, int defStyle) {
...
*/
    ...
    private void addAttrInfo()
    {
        ...
        plotAttrInfo.addAttributeInfo(XEnum.Location.BOTTOM, "A", 0.5f, paintTB);
